...
public class ExtractTest {
    ...
    */
	 ...
	 */
    //Review: 1. You should check the case with tweets.length = 0 and > 2. 
    @Test
	 ...
	 * 6. [v] username-mention in tweet messages [v] legal [v] belong to any author in tweets(username-mention in uppercase)
	 //Review: 
     // 1. You should also check if "jimmy" and "JERRY" are actually in the resulting mentioned-user list. 
     // 2. Check if the result string set is case-insensitive if the input text contains the same username with different "case", e.g., "JIMMY" and "jimmy". 
	 */
