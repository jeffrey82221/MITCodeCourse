...
public class FilterTest {
    ...
    */
     ...
     */
    // Review: You should check if the identification of tweet with an author name is case insensitive by providing upper-case author name. 
    // covers one tweet
    @Test
     ...
     * 3. more than one tweet in time span //Review: should assert that the number of resulting tweets are as expected. 
     ...
     */
    //Review: 
    // 1. should consider the case with text with more than one word.  
    // 2. should consider the case with more than one tweet 
