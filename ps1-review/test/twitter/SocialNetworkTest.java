...
public class SocialNetworkTest {
    ...
    */
	 ...
	 */
    // Review: 
    // 1. should consider the number of followers in each tweet. (consider: 0, 1, or 2 (> 1)). 
    // 2. should consider the number of users following a certain user. (consider: 0, 1, or 2 (> 1)).  
