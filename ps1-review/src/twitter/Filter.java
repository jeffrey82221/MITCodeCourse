...
public class Filter {
    ...
    public static List<Tweet> writtenBy(List<Tweet> tweets, String username) {
        ...
        return tweets
                ...
                // Review: But what if the username of a tweet is in upper-case? 
                // consider: .filter(tweet -> tweet.getAuthor().toLowerCase().equals(username.toLowerCase())) 
        		.collect(Collectors.toList()); //Good Use! 
    }
