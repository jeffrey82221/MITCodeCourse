...
public class Extract {
    ...
    public static Timespan getTimespan(List<Tweet> tweets) {
    	final Tweet tweetWithLargestTimeStamp = Collections.max(tweets, (a, b) -> a.getTimestamp().compareTo(b.getTimestamp()));  //Good Use!
    	final Tweet tweetWithSmallestTimeStamp = Collections.min(tweets, (a, b) -> a.getTimestamp().compareTo(b.getTimestamp())); //Good Use!
     ...
     */
    // Review: 
    // This function did not pass the below test:
    /*
    ...
    */
    public static Set<String> getMentionedUsers(List<Tweet> tweets) {
        ...
        final String regexUsernameMention = "^(\\W)*@(\\w){1,15}(\\W)*$"; //Good Use! Can you explain how it is used? 
        // W : not A-Z,a-z,0-9, _ 
        // w : is A-Z,a-z,0-9, _ 
        // * : the char exist 0 or more times 
